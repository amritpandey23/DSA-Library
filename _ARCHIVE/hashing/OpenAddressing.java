...
public class OpenAddressing {
    ...
    public static void main(String[] args) {
        // code here
        int[] A = new int[7];
        doubleHashingInsert(A, 49);
        doubleHashingInsert(A, 63);
        doubleHashingInsert(A, 56);
        doubleHashingInsert(A, 52);
        doubleHashingInsert(A, 54);
        doubleHashingInsert(A, 48);
        for (int n : A) {
            System.out.print(n + " ");
        }
    }

    public static void doubleHashingInsert(int[] A, int x) {
        // h = (h1(x) + h2(x) * i) % m
        // h1(x) = h1 % m
        // h2(x) = 6 - x % 6 
        boolean empty = false;
