...
public class VerticalWidth {
    ...
    public static int findVerticalWidth(TreeNode root) {
        ...
        while (!Q.isEmpty()) {
            ...
            set.add(curr.y);
            if (curr.x.left != null) {
                Q.offer(new Pair<TreeNode, Integer>(curr.x.left, curr.y - 1));
            }
            if (curr.x.right != null) {
                Q.offer(new Pair<TreeNode, Integer>(curr.x.right, curr.y + 1));
            }
        }
        return set.size();
    }
